...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_53%"
    ...
    RawEcuPacketHex   = "4752423296730204281235480C0C324B96"
    CalculatedWavePsi = 0.000612
    LastSyncTimestamp = "2026-07-16 07:16:24"
}
