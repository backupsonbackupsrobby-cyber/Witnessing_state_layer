...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_54%"
    ...
    RawEcuPacketHex   = "4752473296730204281236480C0C324B96"
    CalculatedWavePsi = 0.00061575
    LastSyncTimestamp = "2026-07-16 07:17:08"
}
