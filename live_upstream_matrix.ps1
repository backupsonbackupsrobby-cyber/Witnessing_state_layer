...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_59%"
    ...
    RawEcuPacketHex   = "47525D369673020428123B4A0C0C324B96"
    CalculatedWavePsi = 0.00063225
    LastSyncTimestamp = "2026-07-16 07:16:02"
}
