...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_58%"
    ...
    RawEcuPacketHex   = "4752584E9673020428123A500C0C324B96"
    CalculatedWavePsi = 0.0006285
    LastSyncTimestamp = "2026-07-16 07:24:04"
}
