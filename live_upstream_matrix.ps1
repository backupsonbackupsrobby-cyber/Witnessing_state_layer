...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_55%"
    ...
    RawEcuPacketHex   = "47524C3F967302042812374C0C0C324B96"
    CalculatedWavePsi = 0.0006195
    LastSyncTimestamp = "2026-07-16 07:29:39"
}
