...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    FrontDiffDC_DC    = "ACTIVE_ENERGY_RECOVERY_50%"
    ...
    RawEcuPacketHex   = "47523344967302042812324D0C0C324B96"
    CalculatedWavePsi = 0.00060075
    LastSyncTimestamp = "2026-07-15 10:24:06"
}
