...
$ImmunityTelemetry = [PSCustomObject]@{
    ...
    RearDiffDC_DC     = "ACTIVE_ENERGY_RECOVERY_70%"
    TelemetryMonitors = "6_HIGH_PRESSURE_DASH_GAUGES"
    IntakeDefense     = "DUAL_STEEL_WOOL_CATCH_CANS_ACTIVE"
    StructuralState   = "STABLE_PLANE"
    RawEcuPacketHex   = "47520B289673020428122A460C0C324B96"
    CalculatedWavePsi = 0.00057075
    LastSyncTimestamp = "2026-07-16 07:08:44"
}
